...
.topnav {
  ...
  <body>
    ...
    <div class="topnav">
      <a class="active" href="Student_Login_Firebase.html"><b>Student Login</b></a>
      <a href="#contact"><b>Helpdesk</b>&nbsp; 044-12345678</a>
    </div>

    <div class="loginbox">
      <h1 style="text-align:center">Canopy Quiz</h1>
      <h2 style="text-align:center">Faculty Login</h2>
      <p>Username</p>
    <input type="email" placeholder="Faculty email" id="email" />
    <p>Password</p>
    <input type="password" placeholder="password" id="password" /> 
    <p>Confirm Password</p>
    <input type="password" placeholder="re type password" id="repassword" /> 
