...
<body>
    <div id="mainDiv">
        ...
        <!-- ==================Home Page================ -->
        <div class="buttons">
		<button class="button" disabled id="startBtn" onclick="startQuiz()"><s>Start Quiz</s></button>
        <button class="button" id="adminBtn" onclick="adminPanel()">Create Quiz</button>
        </div>
        <!-- ==================Quiz Body================ -->
        <div id="mainBody" style="display: none;">
        <button class="button" id="exitBtn" onclick="appendResult()">Finish Quiz</button>
        <div id="quiz">
